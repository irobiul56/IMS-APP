      ...
      <nav class="mt-4 flex-1">
        <ul>
          ...
          <li class="flex items-center p-2 hover:bg-gray-700">
            ...
            <Link :href="route('pos')">
            <span :class="sidebarOpen ? 'block' : 'hidden'">POS</span>
            </Link>
          </li>
          <li class="flex items-center p-2 hover:bg-gray-700">
            ...
            <span :class="sidebarOpen ? 'block' : 'hidden'">Product Add </span>

            
          </li>
          <li class="flex items-center p-2 hover:bg-gray-700">
            <svg class="h-6 w-6 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <Link :href="route('pos')">
            <span :class="sidebarOpen ? 'block' : 'hidden'"> Product List</span>
            </Link>
          </li>
          <li class="flex items-center p-2 hover:bg-gray-700">
            <svg class="h-6 w-6 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <span :class="sidebarOpen ? 'block' : 'hidden'"> Product Category</span>
            </Link>
          </li>
